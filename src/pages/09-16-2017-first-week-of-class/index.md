...
You can imagine, then, how proud I was of myself to think of putting vanilla ice cream onto a [stroopwafel](https://en.wikipedia.org/wiki/Stroopwafel) to make a Dutch ice-cream sandwich.

Unfortunately, I also have two half-fake front teeth, due to tripping and smacking my mouth on concrete when I was about 8-years-old. They rarely chip, but I tend to avoid biting directly into hard foods like apples, without first cutting them and using my back teeth. Still, every once in awhile my front teeth just chip, anyway. As it turns out, a cold stroopwafel was too much for them, so as I was enjoying my invention the night before the first day of class... 
...
<img src="./images/2017-09-11-10.30.49-1.jpg" alt="Me with a chipped tooth">
...
Our classes don't have formal names, but each teacher has a general area of focus, so we will have a well-rounded education this semester, and then go even deeper on an individual thesis project, next semester.
...
**Primary assignment:** creating a type family based on flat-brush calligraphy which will include 4 variations:
- A primary font, optimized for long-form reading
- A high-contrast variation (with a large amount of thick/thin contrast)
...
## Programming in Python, with Just Van Rossum
...
> That's what I love [about experimental design with scripting]. There are no mistakes, only happy little accidents. Keep track of your mistakes.

## Type design practice, with Erik Van Blokland

**Main focus of course:** This course will be the most varied, and is the only course that will happen in each semester. At the start, we will be working with pointed-pen calligraphy, but it seems like this course will be a wide-ranging series of lessons from Erik on type history, font editing, scripting, spacing, and personal practice. 



<img src="./images/2017-09-21-09.49.05.jpg" alt="" />

<img src="./images/2017-09-21-12.20.26.jpg" alt="" />

<img src="./images/2017-09-21-12.15.09.jpg" alt="" />


## Arabic Script, with Kristyan Sarkis
...
Bonus: I found [a great dentist](http://thehaguedentalcare.nl/) who was able to repair my tooth. I was a bit nervous about seeing a dentist in a new country, but the experience at this particular was easy and painless.
